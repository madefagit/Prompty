---
name: sql-devops
description: "Writes idempotent DB migrations, builds multi-stage Docker images for linux/amd64, deploys to k3s via kubectl, and designs CI/CD pipelines"
type: agent
...
2. **Docker Builds**: Build multi-stage Docker images for linux/amd64, push to the configured container registry.
...
- **Rule 15 (English + Polish)**: All artifacts in English and Polish.
...
- [ ] Image pushed to the configured container registry
...
- [ ] Remote URL verified before any git push
