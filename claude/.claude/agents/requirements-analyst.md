...
description: "Uncovers hidden requirements via 5W+H questioning, then produces user stories with Given-When-Then acceptance criteria and an architecture proposal"
type: agent
...
- Constraints: technology choices (EF Core 9 + Npgsql, PostgreSQL 17, Angular 21+), infrastructure, regulatory.
...
- Technology choices aligned with project stack (EF Core 9 + Npgsql, PostgreSQL 17, Angular 21+, .NET 9).
...
- [ ] Technology choices follow project stack (EF Core 9 + Npgsql, Angular 21+, .NET 9)
