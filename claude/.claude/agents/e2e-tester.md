---
name: e2e-tester
description: "Validates system behavior end-to-end via Playwright browser tests, Pact consumer contracts, real-DB integration tests, and k6 load tests"
type: agent
...
- **Rule 15 (English + Polish)**: All test code and documentation in English and Polish.
