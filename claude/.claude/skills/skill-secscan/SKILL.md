---
name: skill-secscan
description: "Sentinel code-audit methodology — taint-path analysis, OWASP Top 10 + CWE Top 25, STRIDE for L/XL changes, zero-hallucination policy, structured remediation tasks"
type: skill
...
| **XSS** | Reflected, stored, DOM-based, mutation XSS, template injection in Angular 21+ |
...
| EF Core 9 | .NET code uses EF Core 9 + Npgsql (no raw ADO.NET, no Dapper) |
