...
description: "Review checklist and output format — five dimensions: security, correctness, performance, maintainability, and Iron Rule compliance"
type: quality
...
- [ ] No SQL injection (EF Core parameterized queries, no raw SQL interpolation?)
...
| EF Core 9 + Npgsql | .NET uses EF Core 9 + Npgsql, not raw ADO.NET or Dapper? |
...
| Rule 15 (English + Polish) | Code/comments/docs in English and Polish? |
