...
description: "Idempotent migration patterns, schema version table, SQLite WAL pragmas, PostgreSQL JSONB specifics, connection pooling, cross-engine data migration"
type: development
