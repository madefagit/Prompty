...
description: "Test isolation rules, Arrange-Act-Assert structure, mock-boundary constraints, 80% coverage thresholds, and protected-test policy across all tech stacks"
type: quality
