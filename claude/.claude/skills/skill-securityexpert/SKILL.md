...
description: "Strategic security layer — 2026 threat landscape, Zero Trust architecture, CTEM, Post-Quantum readiness, Red/Purple team ops, STRIDE threat model template"
type: skill
...
- [ ] Remote URL verified before git push (Rule 4)
